...
function Footer() {
  return (
    <StyledFooter className="container">
      ...
      <IconContainer>
        <li>
          <a href="https://danielcuello-portfolio.netlify.app/">
            <Bs0Circle  className="icons" />
          </a>
        </li>
        <li>
          <a href="https://github.com/DanielCuello">
            <BsGithub className="icons" />
          </a>
        </li>
        <li>
          <a href="https://www.linkedin.com/in/danielgustavocuello/">
